...
var eventsAddedText = document.getElementById('eventadded_text');
...
function newAddEvent(className, dateTimeStart, dateTimeEnd) {
  eventsAddedText.style.display = 'block';
  var event = {
    'summary': className,
    'start': {
...
function addEvent() {
  ...
  var event = {
    ...
    'start': {
      'dateTime': '2021-04-03T09:00:00-07:00',
      'timeZone': 'America/Los_Angeles'
    },
    'end': {
      'dateTime': '2021-04-03T17:00:00-07:00',
      'timeZone': 'America/Los_Angeles'
    },
    'recurrence': [
